...
## Social Menu
The icons added to your Social Menu will automatically populate. To add the icons, create a custom link to the social media location and York Pro will do the rest.
...
## 3. Thumbnail Display Sizes
Within the Portfolio Settings metabox of each post, you may set the grid size for your portfolio project's featured image, that is used on the portfolio templates.

There are four options: small, medium, large and xtra-large.
